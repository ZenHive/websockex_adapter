defmodule WebsockexAdapter.Reconnection do
  @moduledoc """
  ...
  This module is internal to WebsockexAdapter. External code should use
  `WebsockexAdapter.Client.connect/2` which handles initial connection attempts
  and automatic reconnection.
  """
  alias WebsockexAdapter.Config
  ...
  def should_reconnect?(error) do
    case WebsockexAdapter.ErrorHandler.handle_error(error) do
      :reconnect -> true
      _ -> false
    end
  end
