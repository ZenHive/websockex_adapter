defmodule WebsockexAdapter.JsonRpc do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    quote do
      import WebsockexAdapter.JsonRpc, only: [defrpc: 2, defrpc: 3]
    end
  end
  ...
  defmacro defrpc(name, method, opts \\ []) do
    ...
    quote do
      ...
      def unquote(name)(params \\ %{}) do
        WebsockexAdapter.JsonRpc.build_request(unquote(method), params)
      end
    end
  end
